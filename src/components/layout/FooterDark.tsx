...
const FooterDark = () => {
  return (
    <footer className='footer-area relative bg-[#001730] py-[40px] px-[24px]'>
      <div className='container mx-auto'>
        ...
        <p className='mt-[40px] text-center text-xs text-white'>
          ©2023 HanaCare Thuộc công ty Cổ phần Công nghệ LHD
        </p>
      </div>
    </footer>
  );
