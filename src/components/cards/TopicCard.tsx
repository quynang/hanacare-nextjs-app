...
const TopicCard: React.FC<TopicCardProps> = ({ title, image, description }) => {
  return (
    <div className="topics-box-1 h-full rounded-lg hover:shadow-lg hover:-translate-y-1 border group text-center p-8 duration-300 topic-6 slick-slide slick-current slick-active" >
