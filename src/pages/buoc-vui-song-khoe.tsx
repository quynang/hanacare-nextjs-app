    ...
    <div className='bg-[#011C3A]'>
        ...
        <div className='flex flex-col justify-center text-center'>
          ...
          <div className='relative flex justify-center rounded-xl border-2 border-[#329DFF] bg-[#212225] p-[14px] pb-[131px] lg:px-[48px] lg:pt-[48px] lg:pb-[117px]'>
            <div className='max-w-[1000px] text-center text-sm text-white	 lg:text-2xl'>
              ...
              lứa tuổi. Việc đi bộ không chỉ giúp nâng cao thể trạng, mà còn cải
              thiện nhiều về tinh thần. Chính vì vậy, HanaCare đã tạo ra chiến
              dịch "BƯỚC VUI, SỐNG KHOẺ" với mong muốn có thể kêu gọi cộng đồng
              tạo dựng một thói quen tốt trong việc đi bộ mỗi ngày, đồng thời
              trở thành nguồn động lực thúc đẩy với những cá nhân đang mãi chần
              chừ với bộ môn này.
            </div>
      ...
      <section className='flex flex-col items-center bg-[#0D2744] bg-[url("/images/campaign/bg-noise.webp")]  px-4 py-[72px]'>
        ...
        <div className='flex flex-wrap justify-center gap-[67px]'>
          ...
          <img className='w-[180px]' src='images/campaign/the-fox-logo.webp' />
          <img
            className='w-[180px]'
      ...
      >
        ...
        <button className='mt-[40px] bg-[#FF823D] px-[24px] py-[16px] text-[24px] font-bold text-white'>
          THAM GIA NGAY
        </button>
        <img
      ...
      <section
        id='el-4'
        className='relative flex flex-col items-center justify-center bg-center bg-no-repeat  px-4 py-[72px] text-center lg:px-[116px] lg:py-[140px]'
      >
        <div className='flex max-w-[1208px] flex-col items-center justify-center'>
          ...
          <div className='mt-[40px] text-[22px] text-white'>
            Lưu ý: Hành trình của bạn sẽ được hệ thống tính điểm thông qua việc
            đồng bộ với Google Fit (đối với Android), Health Fit (đối với iOS),
            hãy nhớ bật đồng bộ với các ứng dụng trên để tham gia thử thách bạn
            nhé!
          </div>
        </div>
      </section>
