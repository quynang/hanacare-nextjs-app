      ...
      <main>
        <div className="container mx-auto">
          ...
          <section className="topics-area pt-20 xl:pt-28">
            <div className="container mx-auto">
              <div className="section-title text-center max-w-xl mx-auto mb-6 lg:mb-16">
                <h4 className="text-4xl lg:text-5xl text-gray-800 font-bold mb-6">Trải nghiệm cùng HanaCare</h4>
              ...
              <div className="flex justify-center flex-wrap">
                {features.map((item, index) => (
                  <div key={index} className='m-4 w-full md:w-[calc(33.33%-2rem)] lg:w-[calc(25%-2rem)] '>
          ...
          <section className="for-your-employees-area py-20 xl:py-28">
            <div className="container mx-auto">
              <div className="section-title text-center max-w-xl mx-auto">
                <h4 className="text-4xl lg:text-5xl text-gray-800 font-bold mb-6">Dành cho nhân viên của bạn</h4>
          ...
          <section className="articles-area">
            <div className="section-title text-center max-w-xl mx-auto mb-6 lg:mb-16">
              <h4 className="text-4xl lg:text-5xl text-gray-800 font-bold mb-6">Blog HanaCare</h4>
