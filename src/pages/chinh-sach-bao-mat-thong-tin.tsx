...
export default function ChinhSachBaoMatThongTin(props: any) {
...
export async function getServerSideProps(context: any) {
  const url = `https://ghost.hanacare.vn/ghost/api/content/pages/slug/chinh-sach-bao-mat-thong-tin?key=942efd06374ce7156d0bf617c4`;
